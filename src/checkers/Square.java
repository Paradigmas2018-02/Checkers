...
/**
 * Represents a single square contained in Board, represented as a Canvas Also
 * stores the occupant of this position on the board, and squares are aware of
 * their position within the board.
 * 
 * 
...
public class Square extends Canvas {
	...
	@Override
	/**
	 * Have this square redraw itself, removing potential highlighting and
	 * adding/removing an occupant Piece as necessary
	 * 
	...
	public String toString() {
		...
		s.append("Square " + Integer.toString(this.getRow()) + ", col " + Integer.toString(this.getCol()));
		if (this.occupied)
			s.append(" Ocupado");
